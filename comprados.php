        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Productos comprados</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li role="presentation" class="active"><a href="#">Comprados</a></li>
                  </ul>
            ...
            <div class="col-md-9">
                ...
                <div class="page-header margin-0">
                  <h1 class="margin-0">Mis productos <small>Comprados</small></h1>
                </div>

                <p class="pull-right margin-5">
                  <button class="btn btn-default">Enviar lista al correo</button>
                  <button class="btn btn-default">Limpiar lista de productos comprados</button>
                </p>
